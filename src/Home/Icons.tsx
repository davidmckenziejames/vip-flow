...
export const features = [
  {
    ...
    icon: MyIcon,
    bg: "",
    hover: "linear-gradient(to right, #007adf 0%, #00ecbc 100%);",
  },
  {
  ...
  {
    text: "Reduce admin & guest communication",
    icon: MyIcon5,
    bg: "",
    hover: "linear-gradient(to right, #007adf 0%, #00ecbc 100%);",
  },
  ...
  {
    text: "Gather insights & feedback",
    icon: MyIcon9,
    bg: "",
    hover: "linear-gradient(to right, #007adf 0%, #00ecbc 100%);",
  },
  {
    text: "Increase retention and loyalty",
    icon: MyIcon10,
    bg: "",
    hover: "linear-gradient(to right, #007adf 0%, #00ecbc 100%);",
  },
  {
    text: "No more WhatsApp chats",
    icon: MyIcon11,
    bg: "#ff0054",
    hover: "#fff",
  },
  {
    text: "No more phone payments",
    icon: MyIcon11,
    bg: "#ff0054",
    hover: "#fff",
  },
  {
    text: "No more wasted time, effort, & costs",
    icon: MyIcon11,
    bg: "#ff0054",
    hover: "#fff",
  },
